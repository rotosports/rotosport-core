# Rotosports Pair Bonded Template

Pair bonded template is an implementation of pair with bonded assets(e.g. ROTO-xROTO, MARS-xMARS, and other tokens that are correlated but have an increasing exchange rate compared to the other token).
