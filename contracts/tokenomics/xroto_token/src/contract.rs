...
use rotosports::asset::addr_opt_validate;
use rotosports::xroto_token::{InstantiateMsg, MigrateMsg, QueryMsg};
...
const CONTRACT_NAME: &str = "rotosports-xroto-token";
...
pub fn migrate(deps: DepsMut, _env: Env, _msg: MigrateMsg) -> StdResult<Response> {
    ...
    match contract_version.contract.as_ref() {
        "rotosports-xroto-token" => match contract_version.version.as_ref() {
            "1.0.0" | "1.0.1" => {}
            _ => {
