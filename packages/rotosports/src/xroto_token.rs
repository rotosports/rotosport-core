...
/// This structure describes the parameters used for creating a xROTO token contract.
#[cw_serde]
...
pub enum QueryMsg {
    ...
    TokenInfo {},
    /// Returns who can mint xROTO and the hard cap on maximum tokens after minting.
    ...
    /// AllAccounts returns all the accounts that have xROTO balances. Supports pagination.
