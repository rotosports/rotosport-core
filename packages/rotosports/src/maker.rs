...
pub struct Config {
    ...
    /// The xROTO staking contract address.
    pub staking_contract: Option<Addr>,
    /// Default bridge asset (Terra1 - LUNC, Terra2 - LUNA, etc.)
    pub default_bridge: Option<AssetInfo>,
    /// The vxROTO fee distributor contract address
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to the vxROTO fee distributor
    pub governance_percent: Uint64,
    /// The ROTO token asset info
    pub roto_token: AssetInfo,
    /// The max spread allowed when swapping fee tokens to ROTO
    pub max_spread: Decimal,
    /// The flag which determines whether accrued ROTO from fee swaps is being distributed or not
    pub rewards_enabled: bool,
    /// The number of blocks over which ROTO that accrued pre-upgrade will be distributed
    pub pre_upgrade_blocks: u64,
    /// The last block until which pre-upgrade ROTO will be distributed
    pub last_distribution_block: u64,
    /// The remainder of pre-upgrade ROTO to distribute
    pub remainder_reward: Uint128,
    /// The amount of collected ROTO before enabling rewards distribution
...
pub struct InstantiateMsg {
    ...
    /// The xROTO staking contract address. If None then governance_contract must be set with 100% fee.
    pub staking_contract: Option<String>,
    /// The governance contract address (fee distributor for vxROTO)
    ...
    /// The maximum spread used when swapping fee tokens to ROTO
...
#[cw_serde]
pub enum ExecuteMsg {
    /// Collects and swaps fee tokens to ROTO
    Collect {
        /// The assets to swap to ROTO
    ...
    /// Add bridge tokens used to swap specific fee tokens to ROTO (effectively declaring a swap route)
    UpdateBridges {
    ...
    /// Distribute ROTO to stakers and to governance
    DistributeRoto {},
...
pub struct ConfigResponse {
    ...
    /// The xROTO staking contract address
    pub staking_contract: Option<Addr>,
    /// The governance contract address (fee distributor for vxROTO stakers)
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to governance_contract
    pub governance_percent: Uint64,
    /// The maximum spread used when swapping fee tokens to ROTO
    pub max_spread: Decimal,
    /// The remainder ROTO tokens (accrued before the Maker is upgraded) to be distributed to xROTO stakers
    pub remainder_reward: Uint128,
    /// The amount of ROTO tokens accrued before upgrading the Maker implementation and enabling reward distribution
    pub pre_upgrade_roto_amount: Uint128,
    /// Parameters that describe the second receiver of fees
    pub second_receiver_cfg: Option<SecondReceiverConfig>,
}
...
/// This struct holds parameters to help with swapping a specific amount of a fee token to ROTO.
#[cw_serde]
