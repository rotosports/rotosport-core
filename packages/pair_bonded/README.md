# Rotosports Pair Bonded Package

Pair bonded package gives a trait that allows implementation pairs with bonded assets(e.g. ROTO-xROTO, MARS-xMARS, and other tokens that are correlated but have an increasing exchange rate compared to the other token).
Use [Pair ROTO-xROTO](/contracts/pair_roto_xroto/) as example of template implementation.
